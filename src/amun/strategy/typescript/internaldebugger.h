...
private:
    void handleStringContent(QString content, v8::Global<v8::Function> &function);

private:
    v8::Isolate *m_isolate;
    Typescript *m_strategy;
    bool m_hasFunctions;
    v8::Global<v8::Function> m_responseCallback;
    v8::Global<v8::Function> m_notificationCallback;
    v8::Global<v8::Function> m_messageLoop;
};
