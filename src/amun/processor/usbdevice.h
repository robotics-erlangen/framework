...
{
public:
    static QList<USBDevice*> getDevices(quint16 vendorId, quint16 productId);

private:
    USBDevice(QSharedPointer<USBContext> context, void *device);
...
private:
    QSharedPointer<USBContext> m_context;
