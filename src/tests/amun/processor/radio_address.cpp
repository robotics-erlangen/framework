...
TEST(Radio_Address, Generation) {
    ...
    Address unicast2018 { Unicast, Generation::Gen2025, 1 };
    ASSERT_EQ(unicast2018.generation, Generation::Gen2025);
    Address broadcast2018 { Broadcast, Generation::Gen2025 };
    ASSERT_EQ(broadcast2018.generation, Generation::Gen2025);
}
...
TEST(Radio_Address, Unicast) {
    ...
    Address addr2018 { Unicast, Generation::Gen2025, 1 };
...
TEST(Radio_Address, Broadcast) {
    ...
    Address addr2018 { Broadcast, Generation::Gen2025 };
