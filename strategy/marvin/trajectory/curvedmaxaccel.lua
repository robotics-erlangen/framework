...
function CurvedMaxAccel:update(targetPos, targetDir, maxSpeed, endSpeed, accelScale, dribble)
	...
	local accelerationFactor = (accelScale or 1.0) -- factor for max forward speedup and braking
	...
	local rotationAccelerationFactor = 1
	...
	if World.RefereeState == "Stop" or World.RefereeState == "BallPlacementDefensive"
		...
		maxSpeed = math.min(maxSpeed, World.IsLargeField and Constants.stopSpeed or 1)
	end
