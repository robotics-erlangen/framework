local ManMarkBall = (require "../base/class").new("Task.ManMarkBall", require "task/base")
...
ManMarkBall.priority = 3

function ManMarkBall:_init(priorityTarget)
