...
function ShootTest.testCatchProbability()
	...
	vis.addPath("test: Way to Goal", {World.Ball.pos, World.Geometry.OpponentGoal})
	vis.addPath("test: Catch Ball", {robot.pos, catchPos})
	vis.addPath("test: Robot Speed", {robot.pos, robot.pos + robot.speed})
