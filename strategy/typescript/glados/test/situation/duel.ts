let situation = {
	...
	ball = { pos = new Vector(1.01828,1.04611), speed = new Vector(-7.3011e-15,4.162e-15) },
	blueGoalie = 0,
	blueRobots = {
		[0] = {
			pos = new Vector(0.0348015,2.90602),
		...
		[1] = {
		//	task = ShootGoal,
			pos = new Vector(1.03088,1.29415),
			dir = Vector.fromAngle(-1.78715),
			speed = new Vector(3.23482e-06,3.85203e-06),
	...
	yellowRobots = {
		[2] = {
			pos = new Vector(0.00901738,-2.86074),
			dir = Vector.fromAngle(1.18577),
			speed = new Vector(-8.89956e-18,3.24177e-15),
			angularSpeed = Vector.fromAngle(1.48397e-15)
		},
		[3] = {
			pos = new Vector(1.04175,0.750497),
			dir = Vector.fromAngle(1.53592),
			speed = new Vector(-1.59841e-15,9.66132e-16),
