...
import { Priorities } from "glados/trajectory/pathhelper";
	...
	run() {
		...
		switch(currentState) {
			case State.GO_TO_STARTPOSITION:
				this._robot.path.addCircle(World.Ball.pos.x, World.Ball.pos.y, World.Ball.radius*4, undefined, Priorities.BALL)
