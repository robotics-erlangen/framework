...
export const partialAmun: any = {
					...
					"raw": [
						{
							...
							"v_y": -0.03690001,
							"system_delay": 0,
							"time_diff_scaled": 1.43568,
							"omega": -1.83976948,
							"camera_id": 1,
							"vision_processing_time": 10000228
						}
					]
				},
				{
	...
	getGameState(): pb.amun.GameState {
		return {
			...
			"current_action_time_remaining": -61220828
		};
	},
