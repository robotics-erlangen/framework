...
function Defense:init () {
	this._manmarkTargets = {} // opponent -> rating
	this._manmarkAssignments = {} // opponent -> defender
	this._centerbackAssignments = {}

	this._piggyTargets = {} // opponent -> rating
	this._piggyAssignments = {} // opponent -> defender

	this._previousManmarkAssignments = {} // opponent -> defender
	this._previousPiggyAssignments = {} // opponent -> defender
	this._previousBallCenterbacks = {}

	this._ballIsLeft = true
...
function Defense:_nextManmarkAssignment (defenders) {
	...
	for (robot, dangerousness in pairs(this._manmarkTargets)) {
		for (_, defender in ipairs(defenders)) {
			if (this._previousManmarkAssignments[robot] == defender) {
