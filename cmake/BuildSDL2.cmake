...
if (UNIX AND NOT APPLE)
    ...
    if (LIBUDEV_FOUND)
        ...
        set_property(TARGET sdl2 PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${install_dir}/include/SDL2")
        set_target_properties(sdl2 PROPERTIES IMPORTED_LOCATION "${install_dir}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2${CMAKE_SHARED_LIBRARY_SUFFIX}")
        add_dependencies(sdl2 project_sdl2)
        set(SDL2_FOUND true)
    else()
