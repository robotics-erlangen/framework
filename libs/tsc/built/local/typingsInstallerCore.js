    ...
    (function (server) {
        ...
        (function (typingsInstaller) {
            ...
            function endsWith(str, suffix, caseSensitive) {
                ...
                return expectedPos >= 0 &&
                    (str.indexOf(suffix, expectedPos) === expectedPos ||
                        (!caseSensitive && ts.compareStringsCaseInsensitive(str.substr(expectedPos), suffix) === 0 /* Comparison.EqualTo */));
            }
            ...
            function sameFiles(a, b, caseSensitive) {
                return a === b || (!caseSensitive && ts.compareStringsCaseInsensitive(a, b) === 0 /* Comparison.EqualTo */);
            }
            ...
            var TypingsInstaller = /** @class */ (function () {
                ...
                TypingsInstaller.prototype.filterTypings = function (typingsToInstall) {
                    ...
                    return ts.mapDefined(typingsToInstall, function (typing) {
                        ...
                        if (validationResult !== 0 /* JsTyping.NameValidationResult.Ok */) {
                ...
                TypingsInstaller.prototype.watchFiles = function (projectName, files, projectRootPath, options) {
                    ...
                    var createProjectWatcher = function (path, projectWatcherType) {
                        ...
                        var watcher = projectWatcherType === "FileWatcher" /* ProjectWatcherType.FileWatcher */ ?
                            ...
                            _this.watchFactory.watchDirectory(path, function (f) {
                                if (watchers.isInvoked || !ts.fileExtensionIs(f, ".json" /* Extension.Json */)) {
                                    return;
                                }
                            ...
                            }, 1 /* WatchDirectoryFlags.Recursive */, options, projectName, watchers);
                    ...
                    for (var _i = 0, files_1 = files; _i < files_1.length; _i++) {
                        ...
                        if (file.endsWith("/package.json") || file.endsWith("/bower.json")) {
                            ...
                            createProjectWatcher(file, "FileWatcher" /* ProjectWatcherType.FileWatcher */);
                            continue;
                        }
                        ...
                        if (ts.containsPath(projectRootPath, file, projectRootPath, !this.installTypingHost.useCaseSensitiveFileNames)) {
                            ...
                            if (subDirectory !== -1) {
                                // Watch subDirectory
                                createProjectWatcher(file.substr(0, subDirectory), "DirectoryWatcher" /* ProjectWatcherType.DirectoryWatcher */);
                            }
                            else {
                                // Watch the directory itself
                                createProjectWatcher(file, "DirectoryWatcher" /* ProjectWatcherType.DirectoryWatcher */);
                            }
                            continue;
                        }
                        ...
                        if (ts.containsPath(this.globalCachePath, file, projectRootPath, !this.installTypingHost.useCaseSensitiveFileNames)) {
                            createProjectWatcher(this.globalCachePath, "DirectoryWatcher" /* ProjectWatcherType.DirectoryWatcher */);
                            continue;
                        }
