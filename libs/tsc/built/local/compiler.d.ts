...
declare namespace ts {
    ...
    export enum ExitStatus {
        ...
        DiagnosticWarningsPresent_OutputsGenerated = 5
    }
...
declare namespace ts {
    const Diagnostics: {
        ...
        Implicit_number_to_boolean_conversions_are_not_allowed: DiagnosticMessage;
    };
}
declare namespace ts {
...
declare namespace ts {
    function createButterflyNodeFactory(): ButterflyFactory;
    const factory: ButterflyFactory;
}
declare namespace ts {
    /**
...
declare namespace ts {
    function createButterflyScriptChecker(checkExpression: (node: Expression | QualifiedName, checkMode?: CheckMode, forceTuple?: boolean) => Type, isTypeAssignableToKind: (source: Type, kind: TypeFlags, strict?: boolean) => boolean, checkNonNullType: (type: Type, node: Node) => Type, isTypeAny: (type: Type | undefined) => boolean | undefined, silentNeverType: IntrinsicType): ButterflyChecker;
}
declare namespace ts {
    function butterflyScriptSubstitution(_hint: EmitHint, node: Node): Node;
}
declare namespace ts {
    interface ButterflyChecker {
        checkTransformVectorBinaryExpression(node: BinaryExpression, checkMode?: CheckMode): Type | undefined;
        checkTransformVectorUnaryExpression(node: PrefixUnaryExpression, operandType: Type, checkMode?: CheckMode): Type | undefined;
        createMapGetterAndSetter(accessExpression: ElementAccessExpression): Type | undefined;
    }
    interface ButterflyFactory extends NodeFactory {
        createOverloadedFunction(left: Expression, right: Array<Expression>, functionName: string, location: TextRange): CallExpression;
    }
}
declare namespace ts {
...
declare namespace ts {
    ...
    export function performIncrementalCompilation(input: IncrementalCompilationOptions): ExitStatus.Success | ExitStatus.DiagnosticsPresent_OutputsSkipped | ExitStatus.DiagnosticsPresent_OutputsGenerated | ExitStatus.DiagnosticWarningsPresent_OutputsGenerated;
    export {};
}
declare namespace ts {
