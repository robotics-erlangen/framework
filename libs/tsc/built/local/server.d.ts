...
declare namespace ts.server {
    ...
    abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
         ...
         */
        beginEnablePluginAsync(pluginConfigEntry: PluginImport, searchPaths: string[], pluginConfigOverrides: Map<any> | undefined): Promise<BeginEnablePluginResult>;
        /**
...
declare namespace ts.server {
    ...
    export class ProjectService {
        ...
        requestEnablePlugin(project: Project, pluginConfigEntry: PluginImport, searchPaths: string[], pluginConfigOverrides: Map<any> | undefined): void;
